...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="grid-4">
				<PublishingWebControls:RichHtmlField FieldName="Block_x0020_2" runat="server"></PublishingWebControls:RichHtmlField>
				<WebPartPages:WebPartZone id="WebpartZoneBlock2" runat="server" title="Zone Block 2"></WebPartPages:WebPartZone>
			</div>
			<div class="grid-4">
				<PublishingWebControls:RichHtmlField FieldName="Block_x0020_3" runat="server"></PublishingWebControls:RichHtmlField>
				<WebPartPages:WebPartZone id="WebpartZoneBlock3" runat="server" title="Zone Block 3"></WebPartPages:WebPartZone>
			</div>
		</div>
